...
#[constant]
pub const SEED_SA: &[u8] = b"tomo_sa";
...
pub mod authority_pda {
    ...
    declare_id!("9j2uoeU3hF9isyCa1NVibfe9bMCc6ss2VT1VZ3aEeY1N"); // sa authority
}
...
pub mod raydium_swap_program {
    use anchor_lang::declare_id;
    declare_id!("675kPX9MHTjS2zt1qfr1NYHuzeLXfQM9H24wFSUt1Mp8"); // mainnet
    // declare_id!("HWy1jotHpo6UqeQxx49dpYYdQB8wj9Qk9MdxwjLvDHB8"); // devnet
}

pub mod raydium_stable_program {
    use anchor_lang::declare_id;
    declare_id!("5quBtoiQqxF9Jv6KYKctB59NT3gtJD2Y65kdnB1Uev3h"); // mainnet
    // declare_id!("DDg4VmQaJV9ogWce7LpcjBA9bv22wRp5uaTPa5pGjijF"); // devnet
}

pub mod raydium_clmm_program {
    use anchor_lang::declare_id;
    declare_id!("CAMMCzo5YL8w4VFF8KVHrK22GGUsp5VTaW7grrKgrWqK"); // mainnet
    // declare_id!("devi51mZmdwUJGU9hjN27vEz64Gps7uUefqxg27EAtH"); // devnet
}

pub mod raydium_cpmm_program {
    use anchor_lang::declare_id;
    declare_id!("CPMMoo8L3F4NbTegBCKVNunggL7H1ZpdTHKxQB5qKP1C"); // mainnet
    // declare_id!("CPMDWBwJDtYax9qW7AyRuVC19Cc4L4Vcy4n2BHAbHkCW"); // devnet
}
...
pub mod whirlpool_program {
    use anchor_lang::declare_id;
    declare_id!("whirLbMiicVdio4qvUfM5KAg6Ct8VwpYzGff3uctyCc"); // mainnet and devnet
}

pub mod meteora_dynamicpool_program {
    use anchor_lang::declare_id;
    declare_id!("Eo7WjKq67rjJQSZxS6z3YkapzY3eMj6Xy8X5EQVn5UaB"); // mainnet and devnet
}

pub mod meteora_dlmm_program {
    use anchor_lang::declare_id;
    declare_id!("LBUZKhRxPF3XUpBCjp4YzTKgLccjZhTSDM9YuVaPwxo"); // mainnet and devnet
}
...
pub mod openbookv2_program {
    use anchor_lang::declare_id;
    declare_id!("opnb2LAfJYbRMAHHvqjCwQxanZn7ReEHp1k81EohpZb"); // mainnet and devnet
}
